                ...
                <body>
                    ...
                    <div class="container">
                        ...
                        <c:if test="${not empty sessionScope.success}">
                            ...
                            <c:set var="mess" value="${sessionScope.success}" scope="request" />
                            <c:remove var="success" scope="session" />
                        </c:if>

                        <c:if test="${not empty sessionScope.error}">
                            <c:set var="type" value="error" scope="request" />
                            <c:set var="mess" value="${sessionScope.error}" scope="request" />
                                                ...
                                                <c:forEach var="booking" items="${readyForCheckIn}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-danger" style="margin-left: 6px"
