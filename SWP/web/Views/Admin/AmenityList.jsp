                                    ...
                                    <c:forEach items="${amenities}" var="a">
                                        <tr>
                                            ...
                                            <td class="text-end pe-4">
                                                <a href="amenity-detail?id=${a.amenityId}" class="btn btn-sm btn-outline-primary">
                                                    Edit
                                                </a>
                                                <form action="amenities" method="post" class="d-inline" onsubmit="return confirm('Are you sure?');">
                                                    <input type="hidden" name="action" value="delete">
                                                    <input type="hidden" name="amenityId" value="${a.amenityId}">
