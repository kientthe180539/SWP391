                ...
                <div class="summary-section">
                    ...
                    <div class="price-summary">
                        <div class="price-item">
                            ...
                            <span>
                                <fmt:formatNumber value="${roomType.basePrice}" type="currency"
                                                  currencySymbol="VND" />
                            </span>
                        </div>
                        <div class="price-item">
                    ...
                    <div
                        style="background-color: #f0f8ff; padding: 12px; border-radius: 5px; font-size: 13px; color: #1a5f7a;">
                        <strong>⚠️ Note:</strong> Select your check-in and check-out dates to see the total
                        price.
                    </div>
                </div>
            </div>
