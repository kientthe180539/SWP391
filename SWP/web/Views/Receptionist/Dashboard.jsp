    ...
    <div class="container">
        ...
        <div class="actions-section">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
                <a href="${pageContext.request.contextPath}/reservation_approval" class="btn btn-primary">
                    ✓ Approve Reservations
                </a>
                <a href="${pageContext.request.contextPath}/receptionist/reservations" class="btn btn-primary"
                    style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%);">
                    📋 Reservation List
                </a>
                <a href="${pageContext.request.contextPath}/receptionist/checkinout" class="btn btn-primary"
                    style="background: linear-gradient(135deg, #dc3545 0%, #e85d6d 100%);">
                    🔑 Check-in/Check-out
                </a>
                <a href="${pageContext.request.contextPath}/receptionist/direct-booking" class="btn btn-primary"
