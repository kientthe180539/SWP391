                ...
                <div class="room-container">
                    ...
                    <div class="search-section">
                        <form class="search-form" method="GET" action="rooms">
                            <div class="search-group">
                                ...
                                <select id="room-type" name="roomType" class="search-input">
                                    ...
                                    <c:forEach var="type" items="${roomTypes}">
                                        <option value="${type.roomTypeId}" ${type.roomTypeId==selectedType ? 'selected'
                                            : '' }>
                                            ${type.typeName}
                                        </option>
                                    </c:forEach>
                            ...
                            <div class="search-group">
                                ...
                                <input type="date" id="check-in" name="checkIn" class="search-input" value="${checkIn}">
                            </div>
                    ...
                    <div class="pagination">
                        <c:if test="${currentPage > 1}">
                            <a href="rooms?page=${currentPage - 1}&roomType=${selectedType}" class="page-link">&laquo;
                                Prev</a>
                        </c:if>
                        ...
                        <c:if test="${currentPage < totalPage}">
                            <a href="rooms?page=${currentPage + 1}&roomType=${selectedType}" class="page-link">Next
                                &raquo;</a>
                        </c:if>
                    </div>
